        ...
        <div className="toolbar">
          <div className="page-width">
            <ul className="flex toolbar-list">
              <li className="toolbar-item"><a href="#" className="link"><img src={discorg} alt="" className="svg" /></a></li>
              <li className="toolbar-item"><a href="#" className="link"><img src={facebook} alt="" className="svg" /></a></li>
              <li className="toolbar-item"><a href="#" className="link"><img src={instagram} alt="" className="svg" /></a></li>
              <li className="toolbar-item"><a href="#" className="link"><img src={snapchat} alt="" className="svg" /></a></li>
              <li className="toolbar-item"><a href="#" className="link"><img src={twitter} alt="" className="svg" /></a></li>
              <li className="toolbar-item"><a href="#" className="link"><img src={yt} alt="" className="svg" /></a></li>
            </ul>
          </div>
        </div>
                      ...
                      <div className="page-width">
                        <div className="flex container-sections">
                          <div className="flex direction-column section">
                            <div className="title-section"><span>MUSIC</span></div>
                            {music.map((option, index) => ( <a href="#" key={index}><span>{option}</span></a> ))}
                            <div className="flex">
                              <a href="/AllMusic"><span>Shop All Music</span></a>
                          ...
                          <div className="flex direction-column section">
                            <div className="title-section"><span>APPAREL</span></div>
                          </div>
                          <div className="flex direction-column section">
                            <div className="title-section"><span>ACCESSORIES</span></div>
                          </div>
                          <div className="flex direction-column section">
                            <div className="title-section"><span>COLLECTIONS</span></div>
                          </div>
                        </div>
                      </div>
                    </div>
